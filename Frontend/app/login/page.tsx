          ...
          <div className="web-auth-hero">
            ...
            <div className="web-auth-demo-bar">
              ...
              <div className="web-auth-demo-buttons">
                <button
                  type="button"
                  onClick={() => quickFill("admin@company.com", "REMOVED_PASSWORD")}
                ...
                <button
                  type="button"
                  onClick={() => quickFill("hr@company.com", "REMOVED_PASSWORD")}
                  className="web-auth-demo-btn"
                >
                  HR Manager
                </button>
                <button
                  type="button"
                  onClick={() => quickFill("employee@company.com", "REMOVED_PASSWORD")}
                  className="web-auth-demo-btn"
                >
                  Employee
                </button>
