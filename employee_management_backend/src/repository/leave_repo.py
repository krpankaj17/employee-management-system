...
def update_leave_type(
    ...
    if description is not None:
        lt.description = description.strip() if description else None
    if max_days_per_year is not None:
        lt.max_days_per_year = max_days_per_year
...
def delete_leave_type(lt: LeaveType, db: Session) -> None:
