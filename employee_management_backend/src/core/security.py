...
def create_email_verification_token(email: str, expires_delta: datetime.timedelta | None = None) -> str:
    """Generates a signed JWT token proving email verification (valid for 15 minutes)."""
    now = datetime.datetime.now(datetime.timezone.utc)
