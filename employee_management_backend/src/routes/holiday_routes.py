...
@router.get("", response_model=PaginatedHolidays, dependencies=[Depends(get_current_user)])
def list_holidays(
    ...
    """Lists company holidays by year and region. Accessible to all authenticated employees."""
