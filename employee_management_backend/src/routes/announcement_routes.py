...
@router.get("/notifications/inbox", response_model=list[NotificationRecipientOut], dependencies=[Depends(get_current_user)])
...
@router.post("/notifications/{recipient_id}/read", dependencies=[Depends(get_current_user)])
