...
- STRICTLY ONE ADMIN: admin@company.com / REMOVED_PASSWORD
...
def seed_all_data():
    ...
    try:
        ...
        admin_pwd_hash = hash_password("REMOVED_PASSWORD")
        ...
        print(f"  - SINGLE ADMIN CREDS: admin@company.com / REMOVED_PASSWORD")
        print("========================================================\n")
